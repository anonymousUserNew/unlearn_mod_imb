"""
DTD (Descent-to-Delete) Unlearning for Food101
===============================================
...
def run_DTD_unlearning(original_ckpt, save_ckpt_path,
                       device, lr=1e-4, epochs=15, batch_size=32,
                       num_workers=4, patience=5, noise_multiplier=0.01,
                       grad_clip=1.0):
    """
    Run DTD unlearning on Food101 dataset.
    """
    print("\n" + "="*70)
...
if __name__ == "__main__":
    ...
    SAVE_CKPT_PATH = "/home/team2/Unlearning/Food101-files/models/unimodal_unlearn/food101_unlearned_dtd.pth"
