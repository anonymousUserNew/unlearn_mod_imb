"""
L-CODEC (Conditional Independence) Unlearning for Food101
==========================================================
...
def compute_diagonal_fisher(model, loader, device, desc=""):
    ...
    for batch in tqdm(loader, desc=f"  Computing Fisher [{desc}]"):
        ...
        loss = (criterion(out['text_logits'], labels) +
...
def run_L_CODEC_unlearning(original_ckpt, save_ckpt_path,
                           device, batch_size=32, num_workers=4,
                           noise_multiplier=1.0):
    """
    Run L-CODEC unlearning on Food101 dataset.
...
if __name__ == "__main__":
    ...
    ORIGINAL_CKPT = "/home/team2/Unlearning/Food101-files/models/model_trained.pth"
    SAVE_CKPT_PATH = "/home/team2/Unlearning/Food101-files/models/unimodal_unlearn/food101_unlearned_lcodec.pth"
