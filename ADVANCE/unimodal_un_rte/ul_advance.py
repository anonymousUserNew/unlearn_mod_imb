...
#    model = load_model(save_ckpt_path, NUM_CLASSES, device, weights_only=False)
...
if __name__ == "__main__":
    ...
    SAVE_CKPT_PATH = "/home/team2/Unlearning/ADVANCE/models_rte/unimodal_unlearn/advance_unlearned_ul.pth"
    ...
    print(f"\n{'='*60}")
    print(f"  Runtime (ul_advance.py): {_h:02d}h {_m:02d}m {_s:02d}s  ({_elapsed:.1f}s total)")
    print(f"{'='*60}")