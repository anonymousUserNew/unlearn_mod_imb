"""
Train ADVANCE Dual-ResNet50 Multimodal Model
=============================================
Trains the AdvanceMultimodalModel on the ADVANCE audio-image dataset.
...
MODEL_PATH = os.path.join(BASE_DIR, "models_rte", "advance_trained_rerun_01.pth")
