...
from src.dataset import AdvanceDataset, discover_pairs, FORGET_CLASS, get_full_dataset, get_base_splits, get_forget_splits, get_retain_splits
from src.model   import AdvanceMultimodalModel
from src.labels  import ADVANCE_CLASSES, NUM_CLASSES
...
MODEL_PATH = "/home/team2/Unlearning/ADVANCE/models/unimodal_unlearn/advance_unlearned_lcodec.pth"
# MODEL_PATH = "/home/team2/Unlearning/newDirauth2/ADVANCE_Unlearning/models/advance_unlearned.pth"

# Which data split to evaluate on:
#   "val"    → 20% held-out validation set ← USE THIS for honest evaluation
#              (same reproducible split as training, seed=42, ratio=0.2)
#   "full"   → entire dataset (includes training data — numbers will be inflated)
#   "forget" → only the forget class (default: airport)
...
OUTPUT_DIR = "/home/team2/Unlearning/ADVANCE/outputs/unimodal_unlearn/l_codec/retain"
# OUTPUT_DIR = "/home/team2/Unlearning/newDirauth2/ADVANCE_Unlearning/outputs/unlearn_eval/forget"
# OUTPUT_DIR = "/home/team2/Unlearning/newDirauth2/ADVANCE_Unlearning/outputs/unlearn_eval/retain"
...
# LOAD DATASET
# --------------------------------------------------
# Reproducible val/train split — must match train.py (seed=42, val_ratio=0.2)
VAL_RATIO = 0.2
SPLIT_SEED = 42
...
full_dataset = AdvanceDataset(all_pairs)
...
class_names = ADVANCE_CLASSES  # list of 13 string names
...
# RUN — all 3 branches
# --------------------------------------------------
print(f"\nEvaluating IMAGE-ONLY branch ...")
cm_image, df_image, acc_image = evaluate(branch="image", tag="image_only")
...
comparison_df = pd.DataFrame({
    "Class"             : class_names,
    "Image Accuracy%"   : df_image["Accuracy%"],
