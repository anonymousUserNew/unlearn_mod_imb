...
from src.dataset import DcaseDataset, discover_pairs, FORGET_CLASS, get_full_dataset, get_base_splits, get_forget_splits, get_retain_splits
from src.model   import DcaseMultimodalModel
from src.labels  import DCASE_CLASSES, NUM_CLASSES
...
BATCH_SIZE = 16
# NUM_CLASSES is imported from src.labels (10 for DCASE)

# Which model to evaluate:
MODEL_PATH = "/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_neggrad.pth"
...
OUTPUT_DIR = "/home/team2/Unlearning/Dcase/outputs/unimodal_eval/neggrad/forget"
# OUTPUT_DIR = "/home/team2/Unlearning/Dcase/outputs/unimodal_eval/retain"
# OUTPUT_DIR = "/home/team2/Unlearning/Dcase/outputs/unimodal_eval/val"
...
all_pairs = discover_pairs("train") + discover_pairs("val") + discover_pairs("test")
full_dataset = DcaseDataset(all_pairs, is_train=False)
...
class_names = DCASE_CLASSES  # list of 10 string names
...
def evaluate(branch="fusion", tag="fusion"):
    ...
    with open(f"{OUTPUT_DIR}/{tag}_summary.txt", "w") as f:
        ...
        f.write(f"Dataset: DCASE (10 classes)\n")
