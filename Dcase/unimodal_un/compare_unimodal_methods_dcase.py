"""
Compare All Unlearning Methods for DCASE
=========================================
...
def main():
    ...
    # Models to compare
    MODELS = {
        'Original': '/home/team2/Unlearning/Dcase/models/dcase_trained.pth',
        'NegGrad': '/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_neggrad.pth',
        'DTD': '/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_dtd.pth',
        'UL': '/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_ul.pth',
        'L-CODEC': '/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_lcodec.pth',
    }
    
    # Output directory
    OUTPUT_DIR = '/home/team2/Unlearning/Dcase/outputs/comparison'
    ...
    # Save to CSV
    csv_path = os.path.join(OUTPUT_DIR, 'unlearning_comparison_dcase.csv')
    ...
    # Print summary table
    print("\n" + "="*70)
    print("UNLEARNING METHODS COMPARISON (DCASE)")
    print("="*70)
