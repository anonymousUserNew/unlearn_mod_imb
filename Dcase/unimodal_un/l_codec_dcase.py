"""
L-CODEC (Conditional Independence) Unlearning for DCASE
==========================================================
...
def run_L_CODEC_unlearning(original_ckpt, save_ckpt_path, forget_class,
    ...
    """
    Run L-CODEC unlearning on DCASE dataset.
...
if __name__ == "__main__":
    ...
    SAVE_CKPT_PATH = "/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_lcodec.pth"
    FORGET_CLASS = "bus"
