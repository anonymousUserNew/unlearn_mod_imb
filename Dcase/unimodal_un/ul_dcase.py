"""
UL (Uncertainty Learning) Unlearning for DCASE
=================================================
...
def train_one_epoch_UL(model, forget_loader, optimizer, device, epoch):
    ...
    for batch in tqdm(forget_loader, desc=f"  Epoch {epoch} [UL]"):
        ...
        loss = (uncertainty_loss(out['audio_logits'], NUM_CLASSES) +
                uncertainty_loss(out['video_logits'], NUM_CLASSES) +
        ...
        with torch.no_grad():
            ...
            total_max_prob += max_prob * vids.size(0)
...
def run_UL_unlearning(original_ckpt, save_ckpt_path, forget_class,
    ...
    """
    Run UL unlearning on DCASE dataset.
    """
    print("\n" + "="*70)
...
if __name__ == "__main__":
    ...
    ORIGINAL_CKPT = "/home/team2/Unlearning/Dcase/models/dcase_trained.pth"
    SAVE_CKPT_PATH = "/home/team2/Unlearning/Dcase/models/unimodal_unlearn/dcase_unlearned_ul.pth"
    FORGET_CLASS = "bus"
