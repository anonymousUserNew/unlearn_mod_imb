...
UNLEARNED_MODEL_PATH = os.path.join(BASE_DIR, "models", "dcase_unlearned_embed.pth")  # v4
CHECKPOINT_PATH      = os.path.join(BASE_DIR, "models", "dcase_unlearned_embed_chk.pth")
