...
class CremaMultimodalModel(nn.Module):
    """
    Dual-ResNet50 model for CREMA-D audio-image classification.

    :param num_classes: Number of target classes (6 for CREMA-D).
    :param embed_dim:   Projected embedding size (default 512).
    :param dropout:     Dropout probability in classifiers.
    """

    def __init__(self, num_classes: int = 6, embed_dim: int = 512, dropout: float = 0.3):
        super().__init__()
