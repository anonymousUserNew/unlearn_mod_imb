"""
Base Utilities for CREMA-D Unlearning Experiments
==================================================
...
def load_model(checkpoint_path, num_classes, device):
    """
    Load the CremaMultimodalModel from a checkpoint.

    Args:
        checkpoint_path: Path to .pth checkpoint
        num_classes: Number of classes (6 for CREMA-D)
        device: torch.device

    Returns:
        model: CremaMultimodalModel instance loaded to device
    """
...
def save_checkpoint(model, save_path, epoch=0, val_acc=0.0):
    ...
    Args:
        model: CremaMultimodalModel instance
