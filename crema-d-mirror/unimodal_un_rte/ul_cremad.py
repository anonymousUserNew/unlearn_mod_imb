"""
UL (Uncertainty Learning) Unlearning for CREMA-D
=================================================
...
def run_UL_unlearning(original_ckpt, save_ckpt_path, forget_class,
    ...
    """
    Run UL unlearning on CREMA-D dataset.
    """
    print("\n" + "="*70)
...
if __name__ == "__main__":
    ...
    SAVE_CKPT_PATH = "/home/team2/Unlearning/crema-d-mirror/models/unimodal_unlearn/crema_unlearned_ul.pth"
    FORGET_CLASS = "HAP"
