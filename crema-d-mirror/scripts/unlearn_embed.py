...
UNLEARNED_MODEL_PATH = os.path.join(BASE_DIR, "models", "crema_unlearned_05_embed.pth")  # v4
CHECKPOINT_PATH      = os.path.join(BASE_DIR, "models", "crema_unlearned_05_embed_checkpoint.pth")  
