...
# from src.labels  import CREMA_CLASSES, NUM_CLASSES, LABEL_MAP

# # =============================================================================
# # CONFIG  ← edit these
# # =============================================================================
# MODEL_PATH  = "/home/team2/Unlearning/crema-d-mirror/models/crema_unlearned_05_embed.pth"
# OUTPUT_DIR  = "/home/team2/Unlearning/crema-d-mirror/outputs/tsne/unlearned_embed"
...
# # =============================================================================
# all_fused, all_video, all_audio, all_labels = [], [], [], []

# print("Extracting embeddings ...")
# with torch.no_grad():
#     for batch in loader:
#         video = batch["video"].to(DEVICE)
#         audio  = batch["spectrogram"].to(DEVICE)
#         labels = batch["label"]

#         out = model(video, audio, return_intermediate=True)

#         all_fused.append(out["fused_emb"].cpu().numpy())
#         all_video.append(out["vid_emb"].cpu().numpy())
#         all_audio.append(out["aud_emb"].cpu().numpy())
#         all_labels.append(labels.numpy())

# all_fused  = np.concatenate(all_fused,  axis=0)   # (N, 512)
# all_video    = np.concatenate(all_video,    axis=0)   # (N, 512)
# all_audio    = np.concatenate(all_audio,    axis=0)   # (N, 512)
...
#         alpha=0.92,
#         linewidths=0,
#         label=f"{CREMA_CLASSES[FORGET_IDX]} (forget)",
#         zorder=5,
#     )
...
#     (all_video,   "video_emb",    "t-SNE — Video Embedding"),
#     (all_audio,   "audio_emb",    "t-SNE — Audio Embedding"),
# ]
...
# CONFIG  ← edit these
# =============================================================================
MODEL_PATH  = "/home/team2/Unlearning/crema-d-mirror/models/crema_unlearned.pth"
OUTPUT_DIR  = "/home/team2/Unlearning/crema-d-mirror/outputs/tsne/unlearned_ours"
DEVICE      = "cuda:0" if torch.cuda.is_available() else "cpu"
BATCH_SIZE  = 32
TSNE_PERPLEXITY = 10
TSNE_ITER       = 1000
...
embeddings_cfg = [
    ...
    (all_vid,   all_preds_vid,   "vid_emb",   "t-SNE — Video Embedding"),
