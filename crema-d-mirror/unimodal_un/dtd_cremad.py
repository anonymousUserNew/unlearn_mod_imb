"""
DTD (Descent-to-Delete) Unlearning for CREMA-D
===============================================
...
def run_DTD_unlearning(original_ckpt, save_ckpt_path, forget_class,
                       ...
                       grad_clip=1.0):
    """
    Run DTD unlearning on CREMA-D dataset.
    """
    print("\n" + "="*70)
...
if __name__ == "__main__":
    ...
    SAVE_CKPT_PATH = "/home/team2/Unlearning/crema-d-mirror/models/unimodal_unlearn/crema_unlearned_dtd.pth"
    FORGET_CLASS = "HAP"
